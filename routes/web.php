...
Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['auth' , 'admin']], function(){
	...
	Route::post('/upload', 'ExcelController@import')->name('admin.upload.store');
	Route::get('/export', 'ExcelController@export')->name('admin.export');
	Route::get('/download', 'ExcelController@download')->name('admin.download');
...
Route::get('/about', 'StoreController@about')->name('store.about');
